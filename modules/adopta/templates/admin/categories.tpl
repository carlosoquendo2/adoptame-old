					...
					<div class="col col-lg-4">
						{if !empty($item.image)}
							<div class="input-group thumbnail thumbnail-single with-actions">
								...
								<div class="caption">
									<a class="btn btn-small btn-danger js-cmd-delete-file" href="#" title="{lang key='delete'}" data-file="{$item.image}" data-item="pet_categs" data-field="image" data-id="{$id}"><i class="i-remove-sign"></i></a>
								</div>
							</div>
						{/if}
...
{ia_print_js files='_IA_URL_modules/adopta/js/admin/categories'}