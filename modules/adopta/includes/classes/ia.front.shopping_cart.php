...
/******************************************************************************
 *
 * @Autor:          Carlos Oquendo
 * @Version:        1.0
 * @Descripción:    Clase encargada de manipular los datos de adopta(items)
 *
 ******************************************************************************/
class iaItem extends abstractModuleFront
{
    protected static $_table = 'pet_items';
    protected $_categoriesTable = 'pet_categs';

    protected $_itemName = 'items';
...
SQL;
        ...
        $sql = iaDb::printf($sql, [
            'table_pet_items' => self::getTable(true),
